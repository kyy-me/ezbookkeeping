    ...
    <f7-page no-navbar no-swipeback login-screen hide-toolbar-on-scroll>
        ...
        <f7-list class="no-margin-vertical">
            <f7-list-item>
                <template #title>
                    <small>
                        <f7-link external :href="desktopVersionPath">{{
        ...
        <f7-button
            small
            popover-open=".lang-popover-menu"
                ...
                >
                    <template #after>
                        <f7-icon
                            ...
                            f7="checkmark_alt"
                            v-if="currentLanguageCode === locale"
                        ></f7-icon>
                    </template>
                </f7-list-item>
            </f7-list>
                ...
                <div class="padding-horizontal padding-bottom">
                    ...
                    <div class="margin-top text-align-center">
                        <f7-link
                            ...
                            :text="$t(twoFAVerifyTypeSwitchName)"
                        ></f7-link>
                    </div>
                </div>
            </f7-page-content>
...
export default {
    ...
    methods: {
            ...
            self.rootStore
                ...
                .then((authResponse) => {
                    ...
                    if (authResponse.user) {
                        const localeDefaultSettings = self.$locale.setLanguage(
                            authResponse.user.language
                        );
                    ...
                    if (
                        self.settingsStore.appSettings
                ...
                .catch((error) => {
                    ...
                    if (
                        self.isUserVerifyEmailEnabled &&
                        error.error &&
                        error.error.errorCode === 201020 &&
                        error.error.context &&
                        error.error.context.email
                    ) {
                        self.resendVerifyEmail = error.error.context.email;
                        self.hasValidEmailVerifyToken =
                            error.error.context.hasValidEmailVerifyToken ||
                            false;
                        self.currentPasswordForResendVerifyEmail = "";
        ...
        verify() {
            ...
            self.rootStore
                .authorize2FA({
                    ...
                    passcode:
                        self.twoFAVerifyType === "passcode"
                            ? self.passcode
                            : null,
                    recoveryCode:
                        self.twoFAVerifyType === "backupcode"
                            ? self.backupCode
                            : null,
                })
                .then((authResponse) => {
        ...
        changeLanguage(locale) {
            ...
            this.settingsStore.updateLocalizedDefaultSettings(
                localeDefaultSettings
            );
        },
    },

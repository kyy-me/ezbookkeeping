                ...
                >
                    <f7-swipeout-button
                        ...
                        @click="
                            setAsBaseline(
                                exchangeRate.currencyCode,
                                getConvertedAmount(exchangeRate)
                            )
                        "
                    ></f7-swipeout-button>
                </f7-swipeout-actions>
            ...
            <f7-list-item>
                ...
                <small>
                    <f7-link
                        ...
                        >{{ exchangeRatesData.dataSource }}</f7-link
                    >
                    <span v-else-if="!exchangeRatesData.referenceUrl">{{
...
export default {
    ...
    computed: {
        ...
        displayBaseAmount() {
            return numericCurrencyToString(
                this.baseAmount,
                this.isEnableThousandsSeparator,
                this.settingsStore.appSettings.decimalPoint
            );
        },

<template>
    <f7-page @page:afterin="onPageAfterIn">
        ...
        <f7-list strong inset dividers>
            ...
            ></f7-list-item>
            <f7-list-item
                :title="$t('Transaction Tags')"
                link="/tag/list"
            ></f7-list-item>
            <f7-list-item
                :title="$t('Data Management')"
                link="/user/data/management"
            ></f7-list-item>
            <f7-list-item
            ...
            <f7-list-item
                ...
                link="/user/sessions"
            ></f7-list-item>
            <f7-list-button :class="{ disabled: logouting }" @click="logout">{{
                $t("Log Out")
            }}</f7-list-button>
        </f7-list>
        ...
        <f7-list strong inset dividers>
            ...
            <f7-list-item
                ...
                :after="
                    isEnableApplicationLock ? $t('Enabled') : $t('Disabled')
                "
                link="/app_lock"
            ></f7-list-item>
            ...
            <f7-list-item
                ...
                :after="exchangeRatesLastUpdateDate"
                link="/exchange_rates"
            ></f7-list-item>
            ...
            <f7-list-item>
                ...
                <f7-toggle
                    :checked="isAutoUpdateExchangeRatesData"
                    @toggle:change="isAutoUpdateExchangeRatesData = $event"
                ></f7-toggle>
            </f7-list-item>
            ...
            >
                <select v-model="currencyDisplayMode">
                    <option :value="allCurrencyDisplayModes.None">
                        {{ $t("None") }}
                    </option>
                    <option :value="allCurrencyDisplayModes.Symbol">
                        {{ $t("Currency Symbol") }}
                    </option>
                    <option :value="allCurrencyDisplayModes.Code">
                        {{ $t("Currency Code") }}
                    </option>
                    <option :value="allCurrencyDisplayModes.Name">
                        {{ $t("Currency Name") }}
                    </option>
                </select>
            </f7-list-item>
            ...
            <f7-list-item>
                ...
                <f7-toggle
                    ...
                    @toggle:change="showAccountBalance = $event"
                ></f7-toggle>
            </f7-list-item>
            ...
            <f7-list-item
                ...
                link="/statistic/settings"
            ></f7-list-item>

            <f7-list-item>
                <span>{{ $t("Enable Animation") }}</span>
                <f7-toggle
                    :checked="isEnableAnimate"
                    @toggle:change="isEnableAnimate = $event"
                ></f7-toggle>
            </f7-list-item>

            <f7-list-item
                external
                :title="$t('Switch to Desktop Version')"
                :link="desktopVersionPath"
            ></f7-list-item>
    ...
    computed: {
        ...
        timeZone: {
            ...
            set: function (value) {
                ...
                this.statisticsStore.updateTransactionStatisticsInvalidState(
                    true
                );
            },
        },
        exchangeRatesLastUpdateDate() {
            const exchangeRatesLastUpdateTime =
                this.exchangeRatesStore.exchangeRatesLastUpdateTime;
            return exchangeRatesLastUpdateTime
                ? this.$locale.formatUnixTimeToLongDate(
                      this.userStore,
        ...
        isAutoUpdateExchangeRatesData: {
            get: function () {
                return this.settingsStore.appSettings
            ...
            self.$confirm("Are you sure you want to log out?", () => {
                ...
                self.rootStore
                    ...
                    .then(() => {
                        ...
                        const localeDefaultSettings = self.$locale.initLocale(
                            self.userStore.currentUserLanguage,
                            self.settingsStore.appSettings.timeZone
                        );
                        self.settingsStore.updateLocalizedDefaultSettings(

    ...
    <f7-page no-navbar no-swipeback login-screen hide-toolbar-on-scroll>
        ...
        <f7-list>
            <f7-list-button
                ...
                :text="$t('Unlock with PIN Code')"
                @click="unlockByPin"
            ></f7-list-button>
            <f7-list-button
                v-if="isWebAuthnAvailable"
                :text="$t('Unlock with WebAuthn')"
...
export default {
    ...
    computed: {
        ...
        isWebAuthnAvailable() {
            return (
                this.settingsStore.appSettings.applicationLockWebAuthn &&
    ...
    methods: {
        unlockByWebAuthn() {
            ...
            if (
                !self.settingsStore.appSettings.applicationLockWebAuthn ||
        ...
        unlockByPin(pinCode) {
            ...
            try {
                ...
                if (
                    self.settingsStore.appSettings.autoUpdateExchangeRatesData
                ) {
                    self.exchangeRatesStore.getLatestExchangeRates({
                        silent: true,
                        force: false,

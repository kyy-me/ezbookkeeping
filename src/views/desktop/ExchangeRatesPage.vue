        ...
        <v-col cols="12">
            <v-card>
                <v-layout>
                    ...
                    >
                        <div class="mx-6 my-4">
                            ...
                            <p class="text-body-1 mt-1 mb-3">
                                <a
                                    ...
                                    v-if="
                                        !loading &&
                                        exchangeRatesData &&
                                        exchangeRatesData.referenceUrl
                                    "
                                ...
                                >
                                <span
                                    v-else-if="!loading && !exchangeRatesData"
                                    >{{ $t("None") }}</span
                                >
                            ...
                            <span
                                ...
                                v-if="exchangeRatesDataUpdateTime || loading"
                                >{{ $t("Last Updated") }}</span
                            >
                            <p
                        ...
                        <div class="mx-6 mt-4">
                            ...
                            <amount-input
                                ...
                                :disabled="
                                    ...
                                    !exchangeRatesData.exchangeRates.length
                                "
                                v-model="baseAmount"
                            />
                        </div>
                        ...
                        >
                            ...
                            <span v-else-if="loading">
                                <v-skeleton-loader
                                    class="skeleton-no-margin pt-2 pb-5"
                                    type="text"
                                    :key="itemIdx"
                                    :loading="loading"
                                    v-for="itemIdx in [
                    ...
                    <v-main>
                        <v-window
                            class="d-flex flex-grow-1 disable-tab-transition w-100-window-container"
                            v-model="activeTab"
                        >
                            <v-window-item value="exchangeRatesPage">
                                <v-card variant="flat">
                                    <template #title>
                                        <div
                                            class="title-and-toolbar d-flex align-center"
                                        >
                                            <v-btn
                                    ...
                                    <v-table
                                        class="exchange-rates-table table-striped"
                                        :hover="!loading"
                                    >
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr
                                                class="exchange-rates-table-row-data"
                                                :key="exchangeRate.currencyCode"
                                                v-for="exchangeRate in availableExchangeRates"
                                            >
                                                <td>
...
export default {
    ...
    computed: {
        ...
        availableExchangeRates() {
            return this.$locale.getAllDisplayExchangeRates(
    ...
    methods: {
        reload(force) {
            ...
            self.exchangeRatesStore
                ...
                .then(() => {
                    ...
                    if (
                        this.exchangeRatesData &&
                        this.exchangeRatesData.exchangeRates
                    ) {
                        let foundDefaultCurrency = false;

                        for (
                            let i = 0;
                            i < this.exchangeRatesData.exchangeRates.length;
                            i++
                        ) {
                            const exchangeRate =
                                this.exchangeRatesData.exchangeRates[i];
                        ...
                        if (force) {
                            self.$refs.snackbar.showMessage(
                                "Exchange rates data has been updated"
                            );
                        } else if (!foundDefaultCurrency) {
                            this.$refs.snackbar.showMessage(
                                "There is no exchange rates data for your default currency"
                            );
                        }
                    }
                })
        ...
        getDisplayConvertedAmount(toExchangeRate, isEnableThousandsSeparator) {
            ...
            return getDisplayExchangeRateAmount(
                rateStr,
                isEnableThousandsSeparator
            );
        },
